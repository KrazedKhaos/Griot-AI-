...
interface UbuntuVaultPageProps {
    balance: number;
...
const UbuntuVaultPage: React.FC<UbuntuVaultPageProps> = ({ balance, transactions, onClaimSaturday, onClaimDaily, lastSaturdayClaim, lastDailyClaim, showToast }) => {
...
export default UbuntuVaultPage;